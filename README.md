...
http://localhost:8504 once it's done. Live H2O AutoML results:
https://fraud-pattern-automl.streamlit.app/ (also reads from the shared cloud database).
`docker compose down` shuts everything down without losing data.
